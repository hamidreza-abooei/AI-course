...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for dist in livingGhostPositionDistributions:
            temp_position = dist.argMax()
            temp_dist = self.distancer.getDistance(
                pacmanPosition, temp_position)
        ...
        for a in legal:
            ...
            temp = self.distancer.getDistance(
                successorPosition, ghost_position)
            if temp < dist:
                dist = temp
                action = a
        return action
